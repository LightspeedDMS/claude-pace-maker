#!/bin/bash
#
# SubagentStart Hook - Track subagent entry
#
# This hook fires when a Claude Code subagent (Task tool) is started.
# It sets the in_subagent flag to true to suppress reminders during subagent execution.
#
