#!/bin/bash
#
# SubagentStop Hook - Track subagent exit
#
# This hook fires when a Claude Code subagent (Task tool) has finished responding.
# It clears the in_subagent flag to resume reminders in main context.
#
